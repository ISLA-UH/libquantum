...
def _get_setup(time_array_s: np.array, num_space_dimensions: int, source_position_vector_initial_xyz_m: np.array,
               source_position_vector_final_xyz_m: np.array, receiver_position_vector_initial_xyz_m: np.array,
...
def _get_velocity_mps(speed_mps: float, trajectory_m: float, num_samples: int,
                      position_vector_initial_xyz_m: np.array, position_vector_final_xyz_m: np.array) \
        -> np.array:
    """
...
def _get_final_vals(spacetime_matrix: np.array, receiver_velocity_mx_mps: np.array,
                    source_velocity_mx_mps: np.array, time_array_s: np.array,
                    receiver_position_vector_initial_xyz_m: np.array,
                    source_position_vector_initial_xyz_m: np.array, signal_speed_mps: float,
                    object_speed_mps: float, num_dimensions: int, num_samples: int, inverse: bool = False) \
        -> (np.ndarray, np.ndarray, np.ndarray):
    """
    computes array of times in seconds, Magnitude of range and time, omega over omega center
...
def doppler_forward(tau_source_s: np.array, signal_speed_mps: float, source_speed_mps: float,
                    receiver_speed_mps: float, space_dimensions: int,
                    source_position_vector_initial_xyz_m: np.array, source_position_vector_final_xyz_m: np.array,
                    receiver_position_vector_initial_xyz_m: np.array, receiver_position_vector_final_xyz_m: np.array) \
        -> (np.ndarray, np.ndarray, np.ndarray):
    """
    Apply a doppler shift on a source moving towards the receiver
...
def image_doppler_forward(tau_source_s: np.array, signal_speed_mps: float, source_speed_mps: float,
                          receiver_speed_mps: float, space_dimensions: int,
                          source_position_vector_initial_xyz_m: np.array, source_position_vector_final_xyz_m: np.array,
                          receiver_position_vector_initial_xyz_m: np.array,
...
def doppler_inverse(inv_time_receiver_s: np.array, signal_speed_mps: float, source_speed_mps: float,
                    receiver_speed_mps: float, space_dimensions: int,
                    source_position_vector_initial_xyz_m: np.array, source_position_vector_final_xyz_m: np.array,
                    receiver_position_vector_initial_xyz_m: np.array, receiver_position_vector_final_xyz_m: np.array) \
        -> (np.ndarray, np.ndarray, np.ndarray):
...
def image_doppler_inverse(inv_time_receiver_s: np.array, signal_speed_mps: float, source_speed_mps: float,
                          receiver_speed_mps: float, space_dimensions: int,
                          source_position_vector_initial_xyz_m: np.array, source_position_vector_final_xyz_m: np.array,
                          receiver_position_vector_initial_xyz_m: np.array,
                          receiver_position_vector_final_xyz_m: np.array) \
