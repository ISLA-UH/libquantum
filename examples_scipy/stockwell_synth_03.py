...
from libquantum2.benchmark_signals import synth_03
...
def main(sample_rate, signal_time_base:str='seconds'):
    ...
    sig_in, time_in = synth_03(time_sample_interval=sample_interval, time_duration=1.024)
