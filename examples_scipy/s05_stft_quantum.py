...
if __name__ == "__main__":
    ...
    sig_time_istft, sig_wf_istft = signal.istft(Zxx=sig_stft,
                                                fs=frequency_sample_rate_hz,
                                                window=('tukey', alpha),
                                                nperseg=time_fft_nd,
                                                noverlap=time_fft_nd // 2,
    ...
    ax2.semilogx(sig_stft_frequency_hz, fft_rms_stft_2, '.-')
    ...
    mic_stft_bits_2 = utils.log2epsilon(np.sqrt(np.abs(sig_stft)**2))
    ...
    pltq.plot_wf_mesh_vert(redvox_id='00',
                           wf_panel_a_sig=mic_sig,
                           wf_panel_a_time=time_nd/frequency_sample_rate_hz,
                           mesh_time=sig_stft_time_s,
                           mesh_frequency=sig_stft_frequency_hz,
                           mesh_panel_b_tfr=mic_stft_bits_2,
                           mesh_panel_b_colormap_scaling="range",
                           wf_panel_a_units="Norm",
                           mesh_panel_b_cbar_units="bits",
                           start_time_epoch=0,
